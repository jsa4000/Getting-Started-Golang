...
func configureFlags(api *operations.WebAppAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.WebAppAPI) http.Handler {
	...
	api.RolesCreateRoleHandler = roles.CreateRoleHandlerFunc(func(params roles.CreateRoleParams) middleware.Responder {
		return middleware.NotImplemented("operation roles.CreateRole has not yet been implemented")
	})
	...
	api.RolesDeleteRoleByIDHandler = roles.DeleteRoleByIDHandlerFunc(func(params roles.DeleteRoleByIDParams) middleware.Responder {
		return middleware.NotImplemented("operation roles.DeleteRoleByID has not yet been implemented")
	})
	...
	api.RolesGetAllRolesHandler = roles.GetAllRolesHandlerFunc(func(params roles.GetAllRolesParams) middleware.Responder {
		return middleware.NotImplemented("operation roles.GetAllRoles has not yet been implemented")
	})
	...
	api.RolesGetRoleByIDHandler = roles.GetRoleByIDHandlerFunc(func(params roles.GetRoleByIDParams) middleware.Responder {
		return middleware.NotImplemented("operation roles.GetRoleByID has not yet been implemented")
	})
